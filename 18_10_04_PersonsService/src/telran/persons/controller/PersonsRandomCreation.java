...
public class PersonsRandomCreation {
			...
			private static final int N_PERSONS = 20;
			...
			public static void main(String[] args) {
				...
				if(personsServiece instanceof Persistable) {
					((Persistable) personsServiece).save("TestPerson.txt");
				}
				//if(personsService instanceof Persistable)
				//make ((Persistable) personsServiece).save("nameFile")
			}
